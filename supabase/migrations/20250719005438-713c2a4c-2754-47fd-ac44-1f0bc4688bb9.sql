-- Corrigir a função test_professor_registration para não usar IDs aleatórios
...
BEGIN
  ...
  BEGIN
    -- Verificar se a constraint de foreign key está funcionando
    -- (sem tentar inserir dados inválidos)
  ...
  BEGIN
    -- Verificar se há políticas RLS nas tabelas principais
    IF EXISTS (
